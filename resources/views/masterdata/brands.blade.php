        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-transparent">
                    <h5 class="modal-title">Form Masterdata Brand</h5>
                ...
                <div class="modal-body px-3 pb-2">
                    ...
                    <form id="frm" class="row gy-1 gx-2">
                        @csrf
                        <input type="hidden" name="ms_brand_id" id="ms_brand_id">
                        <div class="col-12">
                            <label class="form-label" for="modalAddCardNumber">Category Name</label>
                            <div class="input-group input-group-merge">
                                <input id="ms_brand_name" name="inp[ms_brand_name]" class="form-control add-credit-card-mask"
                                    type="text" />
                            </div>
                        </div>
...
@section('js_section')
    <script>
        ...
        function edit(id) {
            $.ajax({
                url: '{{ url('api/masterdata/brands/') }}' + '/' + id,
                type: 'get',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
