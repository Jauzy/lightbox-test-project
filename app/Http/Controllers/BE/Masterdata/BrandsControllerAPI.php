    ...
    public function dt()
    {
        ...
        return datatables($data)
            ...
            ->addColumn('action', function ($db) {
                return '
                    <a href="javascript:searchProduct(\''.$db->ms_brand_id.'\')" title="Filter Data" class="btn btn-sm btn-icon btn-secondary"><i class="bx bx-search"></i></a>
                    <a href="javascript:edit(\''.$db->ms_brand_id.'\')" title="Edit Data" class="btn btn-sm btn-icon btn-primary"><i class="bx bx-edit"></i></a>
